...
from code.util import COLUMN_TWEET, COLUMN_LABEL, COLUMN_DATE
...
parser.add_argument("-d", "--day_of_the_week", action = "store true", help = "translate the date into the day of the week")
...
if args.import_file is not None:
    ...
    if args.day_of_the_week:
        # day of the week of the original tweet
