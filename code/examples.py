...
"""Data visualization, Bigrams"""

import csv
import pandas as pd

df = pd.read_csv("data/preprocessing/preprocessed.csv", quoting = csv.QUOTE_NONNUMERIC)
...
text = "John Wilkes Booth shot Abraham Lincoln. But Abraham Lincoln was not shot in the white house"
...
# NER
text = "John Wilkes Booth shot Abraham Lincoln, Abraham Lincoln was not shot in the white house"
...
for w1,w2 in pairs:
    print("{0} - {1}: {2}".format(w1, w2, embeddings.similarity(w1,w1)))
